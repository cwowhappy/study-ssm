package com.cwowhappy.ssm.common.mybatis.mapper.mapperhelper;

import com.cwowhappy.ssm.common.mybatis.mapper.entity.EntityColumn;
import com.cwowhappy.ssm.common.mybatis.mapper.entity.IDynamicTableName;
import com.cwowhappy.ssm.common.mybatis.mapper.util.StringUtil;
...
public class SqlHelper {
    ...
    public static String getDynamicTableName(Class<?> entityClass, String tableName) {
        if (IDynamicTableName.class.isAssignableFrom(entityClass)) {
            return "<if test=\"@com.cwowhappy.ssm.mybatis.mapper.util.OGNL@isDynamicParameter(_parameter) and dynamicTableName != null and dynamicTableName != ''\">\n" +
                    "${dynamicTableName}\n" +
                    "</if>\n" +
                    "<if test=\"@com.cwowhappy.ssm.mybatis.mapper.util.OGNL@isNotDynamicParameter(_parameter) or dynamicTableName == null or dynamicTableName == ''\">\n" +
                    tableName + "\n" +
                    "</if>";
        } else {
            return tableName;
    ...
    public static String getDynamicTableName(Class<?> entityClass, String tableName, String parameterName) {
        if (IDynamicTableName.class.isAssignableFrom(entityClass)) {
            if (StringUtil.isNotEmpty(parameterName)) {
                return "<if test=\"@com.cwowhappy.ssm.mybatis.mapper.util.OGNL@isDynamicParameter(" + parameterName + ") and " + parameterName + ".dynamicTableName != null and " + parameterName + ".dynamicTableName != ''\">\n" +
                        "${" + parameterName + ".dynamicTableName}\n" +
                        "</if>\n" +
                        "<if test=\"@com.cwowhappy.ssm.mybatis.mapper.util.OGNL@isNotDynamicParameter(" + parameterName + ") or " + parameterName + ".dynamicTableName == null or " + parameterName + ".dynamicTableName == ''\">\n" +
                        tableName + "\n" +
                        "</if>";
            } else {
